...
- 🔍 **Diabetes Prediction Model**  
  An **artificial neural network (ANN)** trained on **electronic medical records (EMR)** to predict diabetes with **80% accuracy** and **92% recall**. Utilized **Pandas**, **PyTorch**, and **Scikit-learn** for **feature engineering**, **data preprocessing**, and **model architecture**. 
...
I'm currently leading a team to engineer a breast cancer tumor stage classifier using the TNM grading system with the Data Science & Machine Learning Club at Cal State Fullerton. Developing a **mulitmodal 2.5-Dimensional CNN** employing **MONAI** for medical image processing, augmentation, and **3D deep learning**. 
## 📫 Let's Connect
